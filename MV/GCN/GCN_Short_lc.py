...
class Experiment:
    ...
    def delete_all_previous_runs(self, project_name="MV-short-lc"):
    ...
    def run_hyperparameter_tuning(self):
        ...
        self.delete_all_previous_runs("MV-short-lc")
        
        # Initialize WandB sweep
        sweep_id = wandb.sweep(sweep=SWEEP_CONFIG, project="MV-short-lc")
    ...
    def train_model(self):
        ...
        print(f"[Checkpoint] Edge weight type: {self.edge_weight_type}")
            ...
            for epoch in range(1, Config.MAX_EPOCHS + 1):
                ...
                if epoch % 5 == 0 and not np.isnan(loss):
                    ...
                    log_metrics = {
                        ...
                        "edge_weight_type": self.edge_weight_type,  # Log edge weight type
                        # Training metrics
